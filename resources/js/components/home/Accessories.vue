    ...
    <v-row no-gutters align="center" class="mt-7">
        ...
        <v-col cols="12" sm="8" md="9" lg="9" xl="9">
            <v-row no-gutters justify="space-between">
                <v-col v-if="$vuetify.breakpoint.mdAndUp" class="px-3" cols="4" md="3" lg="3" xl="4">
                    <div class="gic"></div>
                </v-col>

                <v-col cols="12" sm="12" md="6" lg="6" xl="4" style="position: relative;">
                    <v-toolbar-title
                        class="text-center" 
                        :class="{
...
export default {
    ...
    data: () => ({
        skeleton: false,
        images: [
            { id: 1, src: "/images/boys_5.png", text: "0-3 Years", height: 85, margin: 0, active: true },
            { id: 2, src: "/images/girls_5.png", text: "3+ Years", height: 70, margin: 16, active: false },
        ],
        item: 0
    }),
    ...
    computed: {
        grandParent () {
            return this.$store.state.upperMenu.find(category => category.alias === "aksesuarner").alias;
        },

        parent () {
            return this.$store.state.upperMenu.find(category => category.alias === "aksesuarner").children[this.item].alias;
        },

        items () {
            return this.$store.state.upperMenu.find(category => category.alias === "aksesuarner").children[this.item].children;
        },

        products () {
            return this.$store.state.homeProducts.accessories;
        }
    },
